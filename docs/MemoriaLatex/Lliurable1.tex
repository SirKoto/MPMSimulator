...
\end{titlepage}
	...
	\end{table}
		\footnotetext[1]{Obtingut amb la llicència de \textit{GitHub Student Pack}}
		\footnotetext[2]{Obtingut amb la llicència de \textit{Windows Azure Education}}
	...
	\begin{table}
		...
		\begin{tabular}{|| c | c || c | c | c ||}
			...
			\hline
			0 & Total & 601 & - & 24 915.201\euro \\ % 24 915.328
			\hline \hline
	...
	La distribució d'hores addicionals es fa d'acord amb les possibilitats d'imprevistos en les diferents etapes i temps a dedicar en el projecte. Com que el treball usa una metodologia molt ``ràpida" \text{ i} l'assignació d'hores és prou laxa, no s'esperen imprevists importants.
	\par 
